...
from google.adk.agents.llm._functions import _call_tool_in_thread_pool
from google.adk.agents.llm._functions import _get_tool_thread_pool
from google.adk.agents.llm._functions import _is_sync_tool
...
def cleanup_thread_pools():
  yield
  from google.adk.agents.llm import _functions

  # Shutdown all pools
  for pool in _functions._TOOL_THREAD_POOLS.values():
    pool.shutdown(wait=False)
  _functions._TOOL_THREAD_POOLS.clear()
