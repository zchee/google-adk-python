...
from google.adk.agents.llm import _instructions
from google.adk.agents.llm._contents import _add_instructions_to_user_content
from google.adk.agents.llm._contents import request_processor as contents_processor
from google.adk.agents.llm._instructions import request_processor
...
{'key1': 'value1'} and {{'key2': 'value2'}}."""),
  ...
  async for _ in _instructions.request_processor.run_async(
      invocation_context,
      request,
  ):
    pass
